...
namespace AgendeApp.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone,Senha,ConfirmarSenha")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone,Senha,ConfirmarSenha")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
